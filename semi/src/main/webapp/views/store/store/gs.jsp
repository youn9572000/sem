...
<body>
	...
	<script>
	const API_URL = "http://192.168.30.5:4000/api/images";
	const contextPath = "<%= request.getContextPath() %>";
	  ...
	  async function fetchImages(category = "all", subcategory = "", searchText = "") {
          try {
              ...
              if (!container) {
                  console.error("image-container 요소를 찾을 수 없습니다.");
                  return;
              }
    ...
    return hasProductNo && matchesCategory && matchesSubcategory;
});
