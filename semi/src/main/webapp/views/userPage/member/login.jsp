...
<body>
    ...
    <div id="sub_container">
        <form id="registrationForm" action="<%= request.getContextPath() %>/member/login" method="post">
        ...
        <div class="user-login">
            <a href="<%=request.getContextPath()%>/views/userPage/member/idCheck.jsp" class="icon login">아이디 찾기</a>
            <a href="<%=request.getContextPath()%>/views/userPage/member/idCheck.jsp" class="icon signup">비밀번호 찾기</a>
            <a href="<%=request.getContextPath()%>/views/userPage/member/TermSection.jsp" class="icon mypage">회원가입</a>
         </div>
    </div>
    <!--//container-->
